...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para mi persona favorita:\n\nQueria hacer algo diferente para ti, se que lo proximos dias pueden ser un poco complicados, pero aqui estoy siempre de alguna forma para recordarte que no estas sola, y que siempre pienso en ti.\n\nGracias por acompañarme en cada paso, por elegirme cada dia, y por llenar mis días de amor.\n\nTe amo más de lo que las palabras pueden expresar.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Saul";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2026-02-12T00:00:00'); 
  ...
  function update() {
    ...
    container.innerHTML =
      `Te conozco hace: <b>${days}</b> días<br>` +
      `Y los que faltan...`;
